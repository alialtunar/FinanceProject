...
const ECommerce= ({transactionVolume,accountDetails,last5Transactions,last5TransferUsers,totalUsers}) => {
  return (
    <>
      ...
      <CardDataStats title="Son 24 Saatteki Toplam İşlem Hacmi" total={transactionVolume} rate="0.43%" levelUp>
    ...
    <CardDataStats title="Sistemdeki Toplam Kullanıcı Sayısı" total={totalUsers} rate="0.43%" levelUp>
