...
import ECommerce from '../../../components/Dashboard/Admin-E-commerce'; // ECommerce bileşeninin yolu
...
const fetchTransactionVolumeLast24Hours = async () => {
  const response = await fetch(`${API_URL}/TransactionHistory/transaction-volume`);
  if (!response.ok) {
    throw new Error('Network response was not ok');
  }
  return response.json();
