...
const DepositePage = () => {
  ...
  const handleDepositeRequest = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5233/api/TransactionHistory/InitiateDeposit', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5233/api/TransactionHistory/Deposit', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    <div>
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="border-b border-stroke px-7 py-4 dark:border-strokedark">
          <h3 className="font-medium text-black dark:text-white">Para Yatırma</h3>
        </div>
        <div className="p-7">
